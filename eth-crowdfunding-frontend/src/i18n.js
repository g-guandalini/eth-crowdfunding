...
const messages = {
    en: {
      ...
      raised: 'Raised',
      creator: 'Creator',
      value_for_donation_mon: 'Value for donation in {currency}',
      ...
      please_enter_valid_donation_value: 'Please enter a valid donation amount, equal to or greater than 0.001 {currency}.',
      ...
      for_this_project_you_must_donate_exactly: 'For this project, you must donate exactly {amount} {currency}.',
      ...
      goal_withdrawal_successful: 'Goal withdrawal successful! 🎉',
      ...
      donation_refund_successful: 'Donation refund successful! ✅',
      ...
      fixed_donation_label: 'Fixed Donation Value ({currency})',
      ...
      fixed_value_min_error: 'The fixed value must be equal to or greater than 0.001 {currency}.',
      ...
      select_network_to_create_project: "Select a network to create the project",
      please_select_network_above: "Please select a valid network in the header to create a project.",
      show_expired_projects: "Expired Projects",
      show_met_goal_projects: "Met Goals",
    ...
    'pt-br': {
      ...
      connection_rejected: 'Conexão rejeitada pelo usuário.',
      ...
      fixed_donation: 'Doação Fixa',
      deadline: 'Prazo',
      completed: 'Concluído',
      goal: 'Meta',
      raised: 'Arrecadado',
      creator: 'Criador',
      value_for_donation_mon: 'Valor para doação em {currency}',
      service_fee_donation: 'Taxa de serviço: 0.25% sobre o valor da doação.',
      congrats_goal_reached: 'Parabéns! Meta alcançada!',
      deadline_passed_goal_not_reached: 'Prazo encerrado. Meta não alcançada.',
      ...
      withdraw_donation: 'Sacar Doação',
      donors: 'Doadores',
      no_donors_yet: 'Ainda não há doadores para este projeto.',
      project_not_loaded_for_sharing: 'Projeto não carregado para compartilhamento.',
      no_wallet_detected_donate: 'Nenhuma carteira detectada. Por favor, instale e conecte-se para realizar doações.',
      project_not_loaded: 'Projeto não carregado.',
      please_enter_valid_donation_value: 'Por favor, insira um valor válido para a doação, igual ou superior a 0.001 {currency}.',
      confirming_your_donation: 'Confirmando sua doação... Por favor, aguarde a transação ser confirmada.',
      donation_successful: 'Doação realizada com sucesso! 🎉',
      error_donating: 'Erro ao doar:',
      donation_canceled_by_user: 'Doação cancelada pelo usuário.',
      for_this_project_you_must_donate_exactly: 'Para este projeto, você deve doar exatamente {amount} {currency}.',
      an_error_occurred_processing_donation: 'Ocorreu um erro ao processar sua doação. Por favor, tente novamente.',
      no_wallet_detected_withdraw: 'Nenhuma carteira detectada. Por favor, instale e conecte-se para sacar os fundos.',
      requesting_goal_withdrawal: 'Solicitando saque da meta... Por favor, aguarde a transação.',
      goal_withdrawal_successful: 'Saque da meta realizado com sucesso! 🎉',
      error_withdrawing_goal: 'Erro ao sacar meta:',
      goal_withdrawal_canceled_by_user: 'Saque da meta cancelado pelo usuário.',
      ...
      requesting_donation_refund: 'Solicitando reembolso da doação... Por favor, aguarde a transação.',
      donation_refund_successful: 'Reembolso da doação realizado com sucesso! ✅',
      error_requesting_refund: 'Erro ao solicitar reembolso:',
      refund_canceled_by_user: 'Reembolso cancelado pelo usuário.',
      wallet_detected_but_cannot_connect_readonly: 'Carteira detectada, mas não foi possível conectar ou obter o endereço do signatário. Carregando projetos em modo somente leitura (ProjectPage).',
      no_wallet_detected_public_readonly: 'Nenhuma carteira detectada. Carregando projetos com provedor público (somente leitura - ProjectPage).',
      cannot_initialize_ethereum_provider: 'Não foi possível inicializar um provedor Ethereum para ProjectPage. Verifique a configuração do RPC.',
      error_fetching_user_donation: 'Erro ao buscar doação do usuário logado:',
      error_loading_project_with_id: 'Erro ao carregar projeto com ID',
      project_not_found_or_invalid_blockchain_id: 'Projeto não encontrado ou ID inválido na blockchain.',
      an_error_occurred_loading_project_details: 'Ocorreu um erro ao carregar os detalhes do projeto. Verifique a conexão com a blockchain e o URL RPC.',
      fixed_text: 'Fixo',
      donate: 'Doar',
      view_project: 'Ver Projeto',
      all_projects: 'Todos os Projetos',
      my_projects: 'Meus Projetos',
      my_contributions: 'Minhas Colaborações',
      search_projects_by_title_placeholder: 'Buscar projetos por título...',
      sort_by_deadline: 'Ordernar por: Prazo',
      sort_by_progress: 'Ordernar por: Percentual arrecadado em relação à meta',
      sort_by_goal_amount: 'Ordernar por: Meta', 
      create_new_project_title: '✨ Criar Novo Projeto ✨',
      project_title_label: 'Título do Projeto',
      project_title_placeholder: 'Ex: Meu Projeto Incrível',
      characters_count: '{current} / {max} caracteres', // Mensagem parametrizada
      title_exceeded_limit: 'O título do projeto excedeu o limite de {max} caracteres.',
      description_label: 'Descrição',
      description_placeholder: 'Conte mais sobre o seu projeto, o que ele fará e por que ele precisa de apoio.',
      markdown_tip_part1: '📝 Você pode usar ',
      markdown_link_text: 'Markdown',
      markdown_tip_part2: ' para formatar a descrição (ex: **negrito**, *itálico*, ## títulos, etc.).',
      goal_label: 'Meta de Arrecadação ({currency})',
      goal_placeholder: 'Ex: 10.5 (apenas números, use ponto para decimais)',
      deadline_label: 'Data Limite para Arrecadação',
      donation_type_label: 'Tipo de Doação',
      free_value: 'Valor Livre',
      fixed_value: 'Valor Fixo',
      fixed_donation_label: 'Valor Fixo da Doação ({currency})',
      fixed_donation_placeholder: 'Ex: 0.05 (apenas números, use ponto para decimais)',
      creating_project_button: 'Criando Projeto...',
      create_project_button: 'Criar Projeto',
  
      // Mensagens de Validação/Erro (para toasts e console)
      title_required: 'O título do projeto é obrigatório.',
      description_required: 'A descrição do projeto é obrigatória.',
      goal_numeric_positive_error: 'A meta deve ser um número positivo (ex: 0.01, 10).',
      correct_goal_field: 'Corrija o campo \'Meta de Arrecadação\'.',
      deadline_required: 'A data limite é obrigatória.',
      correct_deadline_field: 'Corrija o campo \'Data Limite para Arrecadação\'.',
      deadline_in_future_error: 'A data limite deve ser no futuro.',
      fixed_value_min_error: 'O valor fixo deve ser igual ou superior a 0.001 {currency}.',
      correct_fixed_donation_field: 'Corrija o campo \'Valor Fixo da Doação\'.',
      fixed_value_greater_than_goal_error: 'O valor fixo da doação não pode ser maior que a meta de arrecadação.',
      sending_transaction_confirm_wallet: 'Enviando transação... Por favor, confirme na carteira.',
      transaction_sent_waiting_blockchain: 'Transação enviada! Aguardando confirmação da blockchain...',
      project_created_success: 'Projeto criado com sucesso! ��',
      project_creation_canceled_by_user: 'Criação de projeto cancelada pelo usuário.',
      ...
      select_network_to_create_project: "Selecione uma rede para criar o projeto",
      please_select_network_above: "Por favor, selecione uma rede válida no cabeçalho para criar um projeto.",
      show_expired_projects: "Projetos Vencidos",  
      show_met_goal_projects: "Metas Batidas",   
      advanced_filters: "Filtros Avançados",        
      filters_active: "Filtros Ativos",             
      expired_short: "Vencidos",                    
      completed_short: "Concluídos",                  
    },
  };

// 2. Função para determinar o idioma inicial
function getBrowserLanguage() {
  const navigatorLanguage = navigator.language.toLowerCase();
  if (navigatorLanguage.startsWith('pt')) { // Inclui 'pt-br', 'pt-pt', etc.
    return 'pt-br';
  }
  // Fallback para inglês se não for português ou se não houver preferência específica
  return 'en';
}
...
function getInitialLocale() {
  ...
  // Se não houver salvo, tenta o idioma do navegador
...
const i18n = createI18n({
  ...
  fallbackLocale: 'en', // Idioma de fallback caso uma tradução não seja encontrada no idioma principal
